...
public:
	...
	void DrawPatentMessage(int x, int y, char* spatent, char* sname, DWORD color1 = RGB(0, 0, 0), DWORD color2 = RGB(0, 0, 0), LPDIRECT3DTEXTURE9 clanMark = NULL, BOOL selected = FALSE, int bellaMarkIndex = -1);
	void DrawPatentWithClanMessage(int x, int y, char* sclan, char* spatent, char* sname, DWORD color1 = RGB(0, 0, 0), DWORD color2 = RGB(0, 0, 0), LPDIRECT3DTEXTURE9 clanMark = NULL, BOOL selected = FALSE, int bellaMarkIndex = -1);

	void DrawTwoLineMessage(int x, int y, char* message1, char* message2, DWORD color1 = RGB(0, 0, 0), DWORD color2 = RGB(0, 0, 0), LPDIRECT3DTEXTURE9 clanMark = NULL, BOOL selected = FALSE, int bellaMarkIndex = -1, int Type = 0);

	void DrawCharacterMessage(int x, int y, char* message, int lineSize = 30, LPDIRECT3DTEXTURE9 clanMark = NULL, char* clanName = NULL, DWORD color1 = RGB(0, 0, 0), BOOL selected = FALSE, int bellaMarkIndex = -1, int Type = 0);
