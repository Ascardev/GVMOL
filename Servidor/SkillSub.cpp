...
int OpenPlaySkill(sSKILL* lpSkill)
{
	...
	for (std::vector<int>::iterator it = SkillDisabled.begin(); it != SkillDisabled.end(); it++)
	{
		int pc = (*it);
		if (pc == lpSkill->Skill_Info.CODE)
		{
			return FALSE;
		}
	}
	...
	{
		char szBuff[256];
		wsprintf(szBuff, "SkillCode:%d", lpSkill->Skill_Info.CODE);
		AddChatBuff(szBuff);
	}

	switch (lpSkill->Skill_Info.CODE)
	{
	case SKILL_L_BREAKING:
		if (lpCurPlayer->MotionInfo->State < 0x100)
		{
			if (lpSkill->Skill_Info.FuncPointer() == TRUE)
			{
				lpCurPlayer->AttackSkil = SKILL_PLAY_L_BREAKING;
	...
	case SKILL_H_TRAINING:
		if (lpCurPlayer->MotionInfo->State < 0x100)
		{
			if (lpSkill->Skill_Info.FuncPointer() == TRUE)
			{
				lpCurPlayer->AttackSkil = SKILL_PLAY_H_TRAINING;
				lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
				lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, 0, 0, 0, 0);
	...
	case SKILL_J_BOMB:
		if (lpCurPlayer->MotionInfo->State < 0x100)
		{
			if (lpSkill->Skill_Info.FuncPointer() == TRUE)
			{
				lpCurPlayer->AttackSkil = SKILL_PLAY_J_BOMB;
				lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
				lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, 0, 0, 0, 0);
	...
	case SKILL_STORM:
		if (lpCurPlayer->MotionInfo->State < 0x100)
		{
			if (lpSkill->Skill_Info.FuncPointer() == TRUE)
			{
				lpCurPlayer->AttackSkil = SKILL_PLAY_STORM;
				lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
				lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, 0, 0, 0, 0);
	...
	case SKILL_LAND_M:
		if (lpCurPlayer->MotionInfo->State < 0x100)
		{
			if (lpSkill->Skill_Info.FuncPointer() == TRUE)
			{
				lpCurPlayer->AttackSkil = SKILL_PLAY_LAND_M;
				lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
				lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, 0, 0, 0, 0);
	...
	case SKILL_AMPLIFIED:
		if (lpCurPlayer->MotionInfo->State < 0x100)
		{
			if (lpSkill->Skill_Info.FuncPointer() == TRUE)
			{
				...
				SendProcessSKillToServer(SKILL_PLAY_AMPLIFIED, lpSkill->Point, 0, 0);
	...
	case SKILL_ARCUDA:
		if (lpCurPlayer->MotionInfo->State < 0x100)
		{
			if (lpSkill->Skill_Info.FuncPointer() == TRUE)
			{
				lpCurPlayer->AttackSkil = SKILL_PLAY_ARCURDA;
				lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
				lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, 0, 0, 0, 0);
				...
				SendProcessSKillToServer(SKILL_PLAY_ARCURDA, lpSkill->Point, 0, 0);
	...
	case SKILL_H_BENEDIC:
		if (!lpCharSelPlayer && GetAssaUseEffect(lpCurPlayer, SKILL_H_BENEDIC) == FALSE && lpSkill->Skill_Info.FuncPointer() == TRUE)
		{
			...
			SendProcessSKillToServer(SKILL_PLAY_H_BENEDIC, lpSkill->Point, 0, 0);
	...
	case SKILL_ANIMA:
		if (lpCurPlayer->MotionInfo->State < 0x100)
		{
			if (lpSkill->Skill_Info.FuncPointer() == TRUE)
			{
				lpCurPlayer->AttackSkil = SKILL_PLAY_ANIMA;
				lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
				lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, 0, 0, 0, 0);
				...
				SendProcessSKillToServer(SKILL_PLAY_ANIMA, lpSkill->Point, 0, 0);
	...
	case SKILL_RAMIEL:
		if (lpCurPlayer->MotionInfo->State < 0x100)
		{
			if (lpSkill->Skill_Info.FuncPointer() == TRUE)
			{
				lpCurPlayer->AttackSkil = SKILL_PLAY_RAMIEL;
				lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
				lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, 0, 0, 0, 0);
				...
				SendProcessSKillToServer(SKILL_PLAY_RAMIEL, lpSkill->Point, 0, 0);
	...
	case SKILL_KRISHNA:
		if (lpCurPlayer->MotionInfo->State < 0x100)
		{
			if (lpSkill->Skill_Info.FuncPointer() == TRUE)
			{
				lpCurPlayer->AttackSkil = SKILL_PLAY_KRISHNA;
				lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
				lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, 0, 0, 0, 0);
				...
				SendProcessSKillToServer(SKILL_PLAY_KRISHNA, lpSkill->Point, 0, 0);
	...
	case SKILL_RAGE_UP:
		...
		if (lpCurPlayer->MotionInfo->State < 0x100) {
			if (lpSkill->Skill_Info.FuncPointer() == TRUE) {
				lpCurPlayer->AttackSkil = SKILL_PLAY_RAGE_UP;
				lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
				lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, 0, 0, 0, 0);
				...
				SendProcessSKillToServer(SKILL_PLAY_RAGE_UP, lpSkill->Point, 0, 0);
	...
	case SKILL_WAR_CRY:
		...
		if (lpCurPlayer->MotionInfo->State < 0x100) {
			if (lpSkill->Skill_Info.FuncPointer() == TRUE) {
				lpCurPlayer->AttackSkil = SKILL_PLAY_WAR_CRY;
				lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
				lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, 0, 0, 0, 0);
				...
				dm_SelectRange(lpCurPlayer->pX, lpCurPlayer->pY, lpCurPlayer->pZ, Warcry_Range[lpSkill->Point - 1], FALSE);
	...
	case SKILL_I_BULKUP:
		...
		if (lpCurPlayer->MotionInfo->State < 0x100)
		{
			if (lpSkill->Skill_Info.FuncPointer() == TRUE)
			{
				lpCurPlayer->AttackSkil = SKILL_PLAY_I_BULKUP;
				lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
				lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, 0, 0, 0, 0);
				...
				SendProcessSKillToServer(SKILL_PLAY_I_BULKUP, lpSkill->Point, 0, 0);
	...
	case SKILL_STEELERS:
		...
		if (lpCurPlayer->MotionInfo->State < 0x100) {
			if (lpSkill->Skill_Info.FuncPointer() == TRUE) {
				lpCurPlayer->AttackSkil = SKILL_PLAY_STEELERS;
				lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
				lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, 0, 0, 0, 0);
				...
				SendProcessSKillToServer(SKILL_PLAY_STEELERS, lpSkill->Point, 0, 0);
	...
	case SKILL_L_GHOST:
		if (lpCurPlayer->MotionInfo->State < 0x100)
		{
			if (lpSkill->Skill_Info.FuncPointer() == TRUE && lpSkill->Point)
			{
				...
				lpCurPlayer->MotionLoopSpeed = 70;
				lpCurPlayer->MotionLoop = 1;
				dm_SelectRange(lpCurPlayer->pX, lpCurPlayer->pY, lpCurPlayer->pZ, LandGhost_Range[lpSkill->Point - 1], FALSE);
				dm_SendRangeDamage(lpCurPlayer->pX, lpCurPlayer->pY, lpCurPlayer->pZ, 0, 0, 0, 0, 0, lpCurPlayer->AttackSkil);
				flag++;
			}
		}
	...
	case SKILL_M_PRAY:
		if (lpSkill->Skill_Info.FuncPointer() == TRUE && lpSkill->Point)
		{
			...
			lpCurPlayer->MotionLoopSpeed = 70;
			lpCurPlayer->MotionLoop = 1;
			dm_SelectRange(lpCurPlayer->pX, lpCurPlayer->pY, lpCurPlayer->pZ, MourningOfPray_Range[lpSkill->Point - 1], FALSE);
			dm_SendRangeDamage(lpCurPlayer->pX, lpCurPlayer->pY, lpCurPlayer->pZ, 0, 0, 0, 0, 0, lpCurPlayer->AttackSkil);
			flag++;
		}
		break;
	...
	case SKILL_POLLUTED:
		if (lpCurPlayer->MotionInfo->State < 0x100)
		{
...

			{
				...
				dm_SelectDamageCount(lpCurPlayer, Polluted_AttackNum[lpSkill->Point - 1], Polluted_Area[lpSkill->Point - 1]);
...
int GetSkillDistRange(sSKILL* lpSkill, int AttackRange, int AttackMode)
{
	...
	case SKILL_DARKWAVE:
		if (lpSkill->Point)
		{
			return	DarkWave_Range[lpSkill->Point - 1] * fONE;
		}
		break;
	case SKILL_S_FLARE:
		if (lpSkill->Point)
		{
			return	SpiritualFlare_Range[lpSkill->Point - 1] * fONE;
		}
		break;
	case SKILL_JUDGE:
		if (lpSkill->Point)
		{
			return	Judgement_Range[lpSkill->Point - 1] * fONE;
		}
		break;
	...
	case SKILL_G_COUP:
		if (lpSkill->Point) {
			cnt = AttackRange + G_Coup_Area[lpSkill->Point - 1] * fONE;
			LastAttackRange = cnt;
			return cnt;
		}
	...
	case SKILL_S_FEAR:
		if (lpSkill->Point) {
			cnt = AttackRange + S_Fear_Range[lpSkill->Point - 1] * fONE;
			LastAttackRange = cnt;
			return cnt;
		}
...
int PlaySkillAttack(sSKILL* lpSkill, smCHAR* lpChar)
{
	...
	if (lpSkill->CODE == SKILL_HEALING || lpSkill->CODE == SKILL_ENCHANT_WEAPON ||
		lpSkill->CODE == SKILL_VIRTUAL_LIFE || lpSkill->CODE == SKILL_TRIUMPH_OF_VALHALLA || lpSkill->CODE == SKILL_H_BENEDIC) {
		skFlag = TRUE;
	}
	else {
		skFlag = FALSE;
	...
	if (lpCurPlayer->OnStageField >= 0 &&
		(
			...
			(StageField[lpCurPlayer->OnStageField]->State == FIELD_STATE_VILLAGE && StageField[lpCurPlayer->OnStageField]->FieldCode != 43 && StageField[lpCurPlayer->OnStageField]->FieldCode != 32 &&
				lpCurPlayer->PvP_Param && lpChar->PvP_Param) ||
			(StageField[lpCurPlayer->OnStageField]->FieldCode == PK_FieldState.FieldCode && PK_FieldState.dwPlay_FieldTime > dwPlayTime && !lpChar->PartyFlag)
			))
	{
	}
	else
	...
	{
		char szBuff[256];
		wsprintf(szBuff, "SkillCode:%d", lpSkill->CODE);
		AddChatBuff(szBuff);
	}
	...
	case SKILL_H_HAWK:
		if (lpSkill->Skill_Info.FuncPointer() == TRUE)
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_H_HAWK;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
	...
	case SKILL_R_SLASH:
		if (lpSkill->Skill_Info.FuncPointer() == TRUE)
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_R_SLASH;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, lpChar, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = GetAttackSpeedFrame(lpCurPlayer->smCharInfo.Attack_Speed, 1);
	...
	case SKILL_P_DEITY:
		if (lpSkill->Skill_Info.FuncPointer() == TRUE)
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_P_DEITY;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, lpChar, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = GetAttackSpeedFrame(lpCurPlayer->smCharInfo.Attack_Speed, 1);
	...
	case SKILL_G_NAIL:
		if (lpSkill->Skill_Info.FuncPointer() == TRUE)
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_G_NAIL;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, lpChar, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = GetAttackSpeedFrame(lpCurPlayer->smCharInfo.Attack_Speed, 1);
	...
	case SKILL_TENUS:
		if (lpSkill->Skill_Info.FuncPointer() == TRUE)
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_TENUS;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, lpChar, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			return TRUE;
	...
	case SKILL_IGNIS:
		if (lpSkill->Skill_Info.FuncPointer() == TRUE)
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_IGNIS;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, lpChar, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
	...
	case SKILL_LOW_KICK:
		...
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_LOW_KICK;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, lpChar, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = 70;
	...
	case SKILL_DBBLOW:
		...
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_DBBLOW;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, lpChar, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = 70;
	...
	case SKILL_H_STRAIGHT:
		...
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_H_STRAIGHT;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, lpChar, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = 70;
	...
	case SKILL_PATRIOT:
		...
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_PATRIOT;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, lpChar, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = 70;
	...
	case SKILL_R_ELBOW:
		...
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_R_ELBOW;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, lpChar, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = 70;
	...
	case SKILL_T_CANNON:
		...
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_T_CANNON;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, lpChar, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = 70;
	...
	case SKILL_J_HEELKICK:
		...
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_J_HEELKICK;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, lpChar, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = 70;
	...
	case SKILL_COMBINATION:
		...
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_COMBINATION;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, lpChar, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = 70;
	...
	case SKILL_B_CHECK:
		...
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_B_CHECK;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, lpChar, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = 70;
	...
	case SKILL_TYPHOON:
		...
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_TYPHOON;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, lpChar, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = GetAttackSpeedFrame(lpCurPlayer->smCharInfo.Attack_Speed) + 1;
	...
	case SKILL_WISP:
...

		{
			...
			smTransCommand.code = smTRANSCODE_WISP;
	...
	case SKILL_HOLY_MIND:
		...
		if (lpSkill->Skill_Info.FuncPointer() == TRUE) {
			...
			smTransCommand.LParam = HolyMind_Time[lpSkill->Point - 1];
			smTransCommand.SParam = lpChar->dwObjectSerial;
			smTransCommand.EParam = lpCurPlayer->dwObjectSerial;
	...
	case SKILL_DETORYER:
		...
		if (lpSkill->Skill_Info.FuncPointer() == TRUE) {
			...
			lpCurPlayer->smCharInfo.Attack_Rating +=
				(lpCurPlayer->smCharInfo.Attack_Rating * Destoryer_AttackRate[lpSkill->Point - 1]) / 100;
