...
struct MECH_INFO{
	...
	int Land_M_DamagePercent[10];
	int Land_M_AreaDamage[10][2];
	int Land_M_AttackNum[10];
	int Land_M_Area[10];
	int Land_M_UseMana[10];

	int H_Sonic_Speed[10];
	int H_Sonic_Time[10];
	int H_Sonic_UseMana[10];

	int R_Smash_Rate[10];
	int R_Smash_Damage[10];
	int R_Smash_UseMana[10];

	int P_Enhence_Damage[10][2];
	int P_Enhence_Area[10];
	int P_Enhence_Time[10];
	int P_Enhence_Mana[10];
};
...
struct FIGHTER_INFO{
	...
	int D_Hit_Damage[10];
	int D_Hit_UseMana[10];

	int P_Dash_Damage[10];
	int P_Dash_Range[10];
	int P_Dash_UseMana[10];

	int M_Blow_Damage[10];
	int M_Blow_RangeDamage[10][2];
	int M_Blow_UseMana[10];

	int B_Berserker_AddAttack[10];
	int B_Berserker_SubAbsorb[10];
	int B_Berserker_Time[10];
	int B_Berserker_UseMana[10];
};
...
struct PIKE_INFO{
	...
	int D_Reaper_AddAtk[10];
	int D_Reaper_UseMana[10];

	int F_Spear_Damage[10][2];
	int F_Spear_Num[10];
	int F_Spear_Area[10];
	int F_Spear_UseMana[10];

	int SS_Attack_Absorb[10];
	int SS_Attack_Rating[10];
	int SS_Attack_UseMana[10];

	int Amplified_AddAttack[10];
	int Amplified_AddMinAttack[10];
	int Amplified_SubAbsorb[10];
	int Amplified_Time[10];
	int Amplified_UseMana[10];
};
...
struct ARCHER_INFO{
	...
	int E_Shot_Damage[10];
	int E_Shot_UseMana[10];

	int S_Rope_Range[10];
	int S_Rope_Percent[10];
	int S_Rope_Damage[10];
	int S_Rope_UseMana[10];

	int N_Splash_Damage[10];
	int N_Splash_Range[10];
	int N_Splash_UseMana[10];

	int   C_Trap_Damage[10];
	int   C_Trap_Range[10];
	int   C_Trap_Delay1[10];
	float C_Trap_Delay2[10];
	int   C_Trap_UseMana[10];
};
...
struct KINA_INFO{
	...
	int S_Breaker_Damage[10];
	int S_Breaker_Attack[10];
	int S_Breaker_UseMana[10];

	int C_Moon_Damage[10];
	int C_Moon_Range[10];
	int C_Moon_UseMana[10];

	int S_Blade_Damage[10];
	int S_Blade_UndeadDamage[10];
	int S_Blade_UseMana[10];

	int H_Benedic_UndeadDamage[10];
	int H_Benedic_Time[10];
	int H_Benedic_UseMana[10];
...
struct ATA_INFO{
	...
	int Vengeance_AttackRate[10];
	int Vengeance_AddCritical[10];
	int Vengeance_Range[10];
	int Vengeance_UseMana[10];

	int Talaria_Speed[10];
	int Talaria_Time[10];
	int Talaria_UseMana[10];

	int G_Coup_Damage[10];
	int G_Coup_Area[10];
	int G_Coup_UseMana[10];

	int Arcuda_Damage[10][2];
	int Arcuda_Hit[10];
	int Arcuda_Defense[10];
	int Arcuda_Life[10];
	int Arcuda_UseMana[10];

	int S_Fear_DamagePercent[10];
	int S_Fear_Range[10];
	int S_Fear_UseMana[10];
	int S_Fear_AddCritical[10];
};
...
struct SACER_INFO{
	...
	int S_Impact_Damage[10][2];
	int S_Impact_Area[10];
	int S_Impact_UseMana[10];

	int P_Ice_Damage[10];
	int P_Ice_UseMana[10];

	int Summon_Ramiel_Damage[10][2];
	int Summon_Ramiel_Attack_Delay[10];
	int Summon_Ramiel_UndeadAbsorbPercent[10];
	int Summon_Ramiel_BlockPercent[10];
	int Summon_Ramiel_Time[10];
	int Summon_Ramiel_UseMana[10];

	int Krishna_Defense[10];
	int Krishna_Abs[10];
	int Krishna_Time[10];
	int Krishna_UseMana[10];
};
...
struct MAGE_INFO{
	...
	int Silraphim_Damage[10];
	int Silraphim_Area[10];
	int Silraphim_UseMana[10];

	int Tenus_HP[10];
	int Tenus_Damage[10];
	int Tenus_Time[10];
	int Tenus_UseMana[10];

	int Ignis_Damage[10];
	int Ignis_UseMana[10];

	int Anima_Damage[10];
	int Anima_Mana[10];
	int Anima_Time[10];
	int Anima_UseMana[10];
};
...
struct SHAMAN_INFO
{
	...
	int AdventMigal_AttackPower[10];
...
struct MARTIAL_INFO
{
	...
	int LowKick_Damage[10][2];
	int LowKick_UseMana[10];
	int SMastery_Damage[10];
	int DBBlow_Damage[10];
	int DBBlow_UseMana[10];
	int Straight_Damage[10];
	int Straight_Rate[10];
	int Straight_UseMana[10];
	int RageUp_Speed[10];
	int RageUp_Time[10];
	int RageUp_UseMana[10];
	int Patriot_Damage[10];
	int Patriot_Critical[10];
	int Patriot_UseMana[10];
	int Elbow_Damage[10];
	int Elbow_UseMana[10];
	int SMastery2_Stamina[10];
	int SMastery2_Rate[10];
	int Bulkup_HP[10];
	int Bulkup_Time[10];
	int Bulkup_UseMana[10];
	int Warcry_Damage[10];
	int Warcry_Reduce[10];
	int Warcry_Range[10];
	int Warcry_Time[10];
	int Warcry_UseMana[10];
	int Cannon_Damage[10];
	int Cannon_UseMana[10];
	int HeelKick_Damage[10];
	int HeelKick_UseMana[10];
	int Combination_Damage[10];
	int Combination_UseMana[10];
	int Steelers_Defense[10];
	int Steelers_Time[10];
	int Steelers_UseMana[10];
	int Check_Damage[10];
	int Check_Critical[10];
	int Check_UseMana[10];
	int Typhoon_Damage[10];
	int Typhoon_Rate[10];
	int Typhoon_UseMana[10];
};
