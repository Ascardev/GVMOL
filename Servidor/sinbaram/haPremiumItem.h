...
extern int TelePort_FieldNum[41][3];
...
public:
	...
	DWORD                 m_BigHeadPotionTime;
	DWORD                 m_VipTime;

	DWORD				  m_TerryTime;
	DWORD                 m_WarehousePage;
...
public:
	...
	void SetBigHeadPotionTime(DWORD Time) { m_BigHeadPotionTime = Time; };
	void SetVipTime(DWORD Time) { m_VipTime = Time; };
