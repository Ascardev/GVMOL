...
int TelePort_FieldNum[TELEPORT_FIELDMAX][3] = {
	...
	{20,42,80}, {21,34,140}, {22,27,80}, {23,28,85}, {24,29,90}, {25,31,90}, {26,35,90}, {27,36,90}, {28,37,95}, {29,38,100},

	{30,40,100}, {31,41,100}, {32,43,102}, {33,44,110}, {34,45,115}, {35,46,140}, {36,47,150}, {37,21, 0}, {38,50,155}, {39,51,160}
};
...
{
	UpKeepItemTGAImage[0] = CreateTextureMaterial("image\\Sinimage\\Premium\\ThirdEyes.png", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	UpKeepItemTGAImage[1] = CreateTextureMaterial("image\\Sinimage\\Premium\\ExpUpPotion.png", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	UpKeepItemTGAImage[2] = CreateTextureMaterial("image\\Sinimage\\Premium\\Vampiric.png", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	UpKeepItemTGAImage[3] = CreateTextureMaterial("image\\Sinimage\\Premium\\M_Rechar.png", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);

	UpKeepItemTGAImage[4] = CreateTextureMaterial("image\\Sinimage\\Premium\\M_Might.png", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	UpKeepItemTGAImage[5] = CreateTextureMaterial("image\\Sinimage\\Premium\\M_Reduce.png", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	UpKeepItemTGAImage[6] = CreateTextureMaterial("image\\Sinimage\\Premium\\M_Phoenix.png", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	UpKeepItemTGAImage[7] = CreateTextureMaterial("image\\Sinimage\\Premium\\PhoenixFire.png", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	UpKeepItemTGAImage[8] = CreateTextureMaterial("image\\Sinimage\\Premium\\PhoenixIce.png", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	UpKeepItemTGAImage[9] = CreateTextureMaterial("image\\Sinimage\\Premium\\PhoenixLightning.png", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	UpKeepItemTGAImage[10] = CreateTextureMaterial("image\\Sinimage\\Premium\\PhoenixHeal.png", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	UpKeepItemTGAImage[11] = CreateTextureMaterial("image\\Sinimage\\Premium\\Vampiric_EX.png", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	UpKeepItemTGAImage[12] = CreateTextureMaterial("image\\Sinimage\\Premium\\S_Reduce.png", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	UpKeepItemTGAImage[13] = CreateTextureMaterial("image\\Sinimage\\Premium\\Bighead.png", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	UpKeepItemTGAImage[14] = CreateTextureMaterial("image\\Sinimage\\Premium\\Vip_C.png", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	UpKeepItemTGAImage[15] = CreateTextureMaterial("image\\Sinimage\\Premium\\Vip.png", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	UpKeepItemTGAImage[16] = CreateTextureMaterial("image\\Sinimage\\Premium\\Warehouse_Page.png", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);

	lpUpKeepItemBackImage[0] = LoadDibSurfaceOffscreen("image\\Sinimage\\Premium\\ThirdEyes_Back.png");
	lpUpKeepItemBackImage[1] = LoadDibSurfaceOffscreen("image\\Sinimage\\Premium\\ExpUpPotion_Back.png");
	lpUpKeepItemBackImage[2] = LoadDibSurfaceOffscreen("image\\Sinimage\\Premium\\Vampiric_back.png");
	lpUpKeepItemBackImage[3] = LoadDibSurfaceOffscreen("image\\Sinimage\\Premium\\M_Rechar_back.png");

	lpUpKeepItemBackImage[4] = LoadDibSurfaceOffscreen("image\\Sinimage\\Premium\\M_Might_back.png");
	lpUpKeepItemBackImage[5] = LoadDibSurfaceOffscreen("image\\Sinimage\\Premium\\M_Reduce_back.png");
	lpUpKeepItemBackImage[6] = LoadDibSurfaceOffscreen("image\\Sinimage\\Premium\\M_Phoenix_back.png");
	lpUpKeepItemBackImage[7] = LoadDibSurfaceOffscreen("image\\Sinimage\\Premium\\PhoenixFire_.png");
	lpUpKeepItemBackImage[8] = LoadDibSurfaceOffscreen("image\\Sinimage\\Premium\\PhoenixIce_.png");
	lpUpKeepItemBackImage[9] = LoadDibSurfaceOffscreen("image\\Sinimage\\Premium\\PhoenixLightning_.png");
	lpUpKeepItemBackImage[10] = LoadDibSurfaceOffscreen("image\\Sinimage\\Premium\\PhoenixHeal_.png");
	lpUpKeepItemBackImage[11] = LoadDibSurfaceOffscreen("image\\Sinimage\\Premium\\Vampiric_back_EX.png");
	lpUpKeepItemBackImage[12] = LoadDibSurfaceOffscreen("image\\Sinimage\\Premium\\S_Reduce_back.png");
	lpUpKeepItemBackImage[13] = LoadDibSurfaceOffscreen("image\\Sinimage\\Premium\\Bighead_back.png");
	lpUpKeepItemBackImage[14] = LoadDibSurfaceOffscreen("image\\Sinimage\\Premium\\Vip_back.png");
	lpUpKeepItemBackImage[15] = LoadDibSurfaceOffscreen("image\\Sinimage\\Premium\\Vip_back1.png");
	lpUpKeepItemBackImage[16] = LoadDibSurfaceOffscreen("image\\Sinimage\\Premium\\Warehouse_Page.png");
...
{
	{8,80},{8,116},{8,152},{8,188},{8,224},{44,80},{44,116}, {44,152}, {44,188}, {44,224}
};
...
void cHaPremiumItem::Main()
{
	...
	for (i = 0; i < SINUPKEEPITEM_MAX; i++)
	{
		...
		if (UpKeepItem[i].Visible == true)
		{
			if (i < 5)
			{
				UpKeepItem[i].PosiX = (WinSizeX - 10) - 44;
				UpKeepItem[i].PosiY = (WinSizeY / 2) - 145 + i * 36;
			}
			else
			{
				UpKeepItem[i].PosiX = (WinSizeX - 46) - 44;
				UpKeepItem[i].PosiY = (WinSizeY / 2) - 145 + (i - 5) * 36;
			}
			...
			{
				if (!cTrade.OpenFlag && !cWareHouse.OpenFlag && !cCraftItem.OpenFlag && !cMyShop.OpenFlag && !cCharShop.OpenFlag && !MyShopSendButton && !cShop.OpenFlag && !cAging.OpenFlag)
				{
					UpKeepItem[i].Infoflag = true;
					UseClickPremiumItemFlag = true;

					if (GetAsyncKeyState(VK_RBUTTON) && sinGetKeyClick(VK_CONTROL))
					{
						SelectItemIndex = UpKeepItem[i].TGAImageNumber;
						cMessageBox.ShowMessage3(MESSAGE_PREMIUM_CANCEL, UpKeepItemName[UpKeepItem[i].TGAImageNumber - 1]);
					}
				}
			}
			else
...
void cHaPremiumItem::DrawUp()
{
	...
	for (i = 0; i < SINUPKEEPITEM_MAX; i++)
	{
		if (UpKeepItem[i].Visible == true)
		{
			if (UpKeepItem[i].TGAImageNumber == nsPremiumItem::VIP)
			{
				if (PVIP == 2)
					dsDrawTexImage(UpKeepItemTGAImage[UpKeepItem[i].TGAImageNumber], UpKeepItem[i].PosiX, UpKeepItem[i].PosiY, 38, 38, UpKeepItem[i].Alpha);
				else if (PVIP == 1)
					dsDrawTexImage(UpKeepItemTGAImage[UpKeepItem[i].TGAImageNumber - 1], UpKeepItem[i].PosiX, UpKeepItem[i].PosiY, 38, 38, UpKeepItem[i].Alpha);
			}
			else
			{
				dsDrawTexImage(UpKeepItemTGAImage[UpKeepItem[i].TGAImageNumber - 1], UpKeepItem[i].PosiX, UpKeepItem[i].PosiY, 38, 38, UpKeepItem[i].Alpha);
			...
			case nsPremiumItem::BIGHEAD_POTION:
				...
				if (dwCurrentTime <= 0)
				{
					chaPremiumitem.m_BigHeadPotionTime = 0;
					chaPremiumitem.SetBigHeadPotionTime(chaPremiumitem.m_BigHeadPotionTime);
				}
				break;
			...
			case nsPremiumItem::VIP:
				...
				if (dwCurrentTime <= 0)
				{
					chaPremiumitem.m_VipTime = 0;
					chaPremiumitem.SetVipTime(chaPremiumitem.m_VipTime);
				}
				break;
			}
			...
			{
				DrawSprite(UpKeepItem[i].PosiX + 1, UpKeepItem[i].PosiY + (39 - MinLen), lpUpKeepItemBackImage[UpKeepItem[i].TGAImageNumber - 1], 0, 39 - MinLen, 38, 38);
			}
	...
	for (i = 0; i < SINUPKEEPITEM_MAX; i++)
	{
		if (UpKeepItem[i].Visible == true)
		{
			...
			{
				//InfoBox(UpKeepItem[i].PosiX - 192, UpKeepItem[i].PosiY, 12, 6);
				if (UpKeepItem[i].TGAImageNumber == nsPremiumItem::VIP)
				{
					InfoBox(UpKeepItem[i].PosiX - 192, UpKeepItem[i].PosiY, 23, 15);
				}
				else
					InfoBox(UpKeepItem[i].PosiX - 192, UpKeepItem[i].PosiY, 12, 6);
			}
...
void cHaPremiumItem::RButtonDown(int x, int y)
{
}

void cHaPremiumItem::RButtonUp(int x, int y)
{
}
...
int cHaPremiumItem::UsePremiumItem(int kind)
{
	...
	case 9:
		haCastleSkillUseFlag = 1;
		SetUpKeepItem(nsPremiumItem::BIGHEAD_POTION, SINITEM_TIME_3HOURS, true, UpKeepItemName[13], 50);
		break;
	case 10:
	case 11:
		haCastleSkillUseFlag = 0;
...
int cHaPremiumItem::CheckWindowOpen()
{
	...
	if (cRemodel.OpenFlag)	return false;
	...
	for (i = 0; i < SINUPKEEPITEM_MAX; i++)
	{
		...
		if (UpKeepItem[i].Visible == true)
		{
			if (UpKeepItem[i].Infoflag == true)
			{
				...
				dsTextLineOut(UpKeepItem[i].PosiX - 182, UpKeepItem[i].PosiY + 15, UpKeepItem[i].Id, strlen(UpKeepItem[i].Id));
				FontType = 0;
				char buffer[256];
				memset(buffer, 0, sizeof(buffer));
				SetFontTextColor(RGB(255, 0, 0));
				wsprintf(buffer, "CRTL + B.Direito para Cancelar!", buffer);
				dsTextLineOut(UpKeepItem[i].PosiX - 182, UpKeepItem[i].PosiY + 30, buffer, strlen(buffer));
				...
				case nsPremiumItem::HELP_PET_TERRY:
					wsprintf(strBuff, UpKeepItemDoc[3], 5, "%");
					break;
				...
				case nsPremiumItem::VIP:
					if (PVIP == 2)
						lstrcpy(strBuff, "COMANDOS:\n/ferreiro = Abre Loja\n/mix = Abre Mixing\n/age = Abre o Aging\nI = Maturar Item\nShift = Super Velocidade (apenas ricarten)\nChat Global (10s)\nJogador vip pode reviver sem pergaminhos\ne não perdem ouro/exp ao morrer.");
					else if (PVIP == 1)
						lstrcpy(strBuff, "COMANDOS:\n/ferreiro = Abre Loja\n/mix = Abre Mixing\nChat Global (15s)\nJogador vip pode reviver sem pergaminhos\ne não perdem ouro/exp ao morrer.");
					break;
				}
				...
				//dsTextLineOut(UpKeepItem[i].PosiX + 50, UpKeepItem[i].PosiY + 20 + 30, strBuff, strlen(strBuff));

				dsTextLineOut(UpKeepItem[i].PosiX - 182, UpKeepItem[i].PosiY + 20 + 30, strBuff, strlen(strBuff));

				if (UpKeepItem[i].TGAImageNumber == nsPremiumItem::VIP)
				{
					DWORD Time = UpKeepItem[i].IconTime[1] - UpKeepItem[i].IconTime[0];
					...
					if (Days)
						wsprintf(strBuff, "Tempo : %02d:%02d:%02d:%02d", Days, Hours, Minutes, Seconds);
					else
						wsprintf(strBuff, "Tempo : %02d:%02d:%02d", Hours, Minutes, Seconds);

					//dsTextLineOut(UpKeepItem[i].PosiX + 50, UpKeepItem[i].PosiY + 200, strBuff, strlen(strBuff));

					dsTextLineOut(UpKeepItem[i].PosiX - 182, UpKeepItem[i].PosiY + 220, strBuff, strlen(strBuff));
				}
				else
				{
					SetFontTextColor(RGB(50, 250, 50));
					...
					//dsTextLineOut(UpKeepItem[i].PosiX + 50, UpKeepItem[i].PosiY + 20 + 46, strBuff, strlen(strBuff));

					dsTextLineOut(UpKeepItem[i].PosiX - 182, UpKeepItem[i].PosiY + 20 + 46, strBuff, strlen(strBuff));
				}
			}
		}
	}
