...
{
	MatPcBangPetImage[0] = CreateTextureMaterial("game\\objects\\phpet\\FirePet.TGA", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	MatPcBangPetImage[1] = CreateTextureMaterial("game\\objects\\phpet\\IcePet.TGA", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	MatPcBangPetImage[2] = CreateTextureMaterial("game\\objects\\phpet\\LightningPet.TGA", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	MatPcBangPetImage[3] = CreateTextureMaterial("game\\objects\\phpet\\HealPet.TGA", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
}
