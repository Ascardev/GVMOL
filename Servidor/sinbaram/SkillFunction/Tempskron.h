...
extern int Destoryer_AttackRate[10];
...
extern int sinMasterSkill_Money[20];
extern int sinMasterSkill_PlusMoney[20];

extern int SkillTextColor[10];

extern int NotUseSkillElement[3];
extern int sinMasteryIncreaIndex[20];
...
extern int Polluted_Damage2[10][2];
extern int Polluted_Area[10];
extern int Polluted_Time[10];
extern int Polluted_AttackNum[10];
extern int Polluted_UseMana[10];
extern int PastingShadow_Damage[10];
extern int PastingShadow_UseMana[10];

extern int LowKick_Damage[10][2];
extern int LowKick_UseMana[10];
extern int SMastery_Damage[10];
extern int DBBlow_Damage[10];
extern int DBBlow_UseMana[10];
extern int Straight_Damage[10];
extern int Straight_Rate[10];
extern int Straight_UseMana[10];
extern int RageUp_Speed[10];
extern int RageUp_Time[10];
extern int RageUp_UseMana[10];
extern int Patriot_Damage[10];
extern int Patriot_Critical[10];
extern int Patriot_UseMana[10];
extern int Elbow_Damage[10];
extern int Elbow_UseMana[10];
extern int SMastery2_Stamina[10];
extern int SMastery2_Rate[10];
extern int Bulkup_HP[10];
extern int Bulkup_Time[10];
extern int Bulkup_UseMana[10];
extern int Warcry_Damage[10];
extern int Warcry_Reduce[10];
extern int Warcry_Range[10];
extern int Warcry_Time[10];
extern int Warcry_UseMana[10];
extern int Cannon_Damage[10];
extern int Cannon_UseMana[10];
extern int HeelKick_Damage[10];
extern int HeelKick_UseMana[10];
extern int Combination_Damage[10];
extern int Combination_UseMana[10];
extern int Steelers_Defense[10];
extern int Steelers_Time[10];
extern int Steelers_UseMana[10];
extern int Check_Damage[10];
extern int Check_Critical[10];
extern int Check_UseMana[10];
extern int Typhoon_Damage[10];
extern int Typhoon_Rate[10];
extern int Typhoon_UseMana[10];

extern int D_Reaper_AddAtk[10];
extern int D_Reaper_UseMana[10];

extern int F_Spear_Damage[10][2];
extern int F_Spear_Num[10];
extern int F_Spear_Area[10];
extern int F_Spear_UseMana[10];

extern int SS_Attack_Absorb[10];
extern int SS_Attack_Rating[10];
extern int SS_Attack_UseMana[10];

extern int Amplified_AddAttack[10];
extern int Amplified_AddMinAttack[10];
extern int Amplified_SubAbsorb[10];
extern int Amplified_Time[10];
extern int Amplified_UseMana[10];

extern int D_Hit_Damage[10];
extern int D_Hit_UseMana[10];

extern int P_Dash_Damage[10];
extern int P_Dash_Range[10];
extern int P_Dash_UseMana[10];

extern int M_Blow_Damage[10];
extern int M_Blow_RangeDamage[10][2];
extern int M_Blow_UseMana[10];

extern int B_Berserker_AddAttack[10];
extern int B_Berserker_SubAbsorb[10];
extern int B_Berserker_Time[10];
extern int B_Berserker_UseMana[10];

extern int Land_M_DamagePercent[10];
extern int Land_M_AreaDamage[10][2];
extern int Land_M_AttackNum[10];
extern int Land_M_Area[10];
extern int Land_M_UseMana[10];

extern int H_Sonic_Speed[10];
extern int H_Sonic_Time[10];
extern int H_Sonic_UseMana[10];

extern int R_Smash_Rate[10];
extern int R_Smash_Damage[10];
extern int R_Smash_UseMana[10];

extern int P_Enhence_Damage[10][2];
extern int P_Enhence_Area[10];
extern int P_Enhence_Time[10];
extern int P_Enhence_Mana[10];

extern int E_Shot_Damage[10];
extern int E_Shot_UseMana[10];

extern int S_Rope_Range[10];
extern int S_Rope_Percent[10];
extern int S_Rope_Damage[10];
extern int S_Rope_UseMana[10];

extern int N_Splash_Damage[10];
extern int N_Splash_Range[10];
extern int N_Splash_UseMana[10];

extern int   C_Trap_Damage[10];
extern int   C_Trap_Range[10];
extern int   C_Trap_Delay1[10];
extern float C_Trap_Delay2[10];
extern int   C_Trap_UseMana[10];

extern int J_Bomb_Damage[10];
extern int J_Bomb_RangeDamage[10][2];
extern int J_Bomb_UseMana[10];

extern int R_Slash_Damage[10];
extern int R_Slash_UseMana[10];

extern int V_Stab_Damage[10];
extern int V_Stab_UseMana[10];

extern int Storm_Damage[10];
extern int Storm_UseMana[10];

extern int D_Mastery2_Damage[10];

extern int H_Hawk_Damage[10];
extern int H_Hawk_UseMana[10];

extern int L_Breaking_Damage[10];
extern int L_Breaking_Range[10];
extern int L_Breaking_UseMana[10];

extern int H_Training_IncreaseForce[10];
extern int H_Training_IncreaseAgility[10];
extern int H_Training_Time[10];
extern int H_Training_UseMana[10];