...
extern DWORD ChecksumSkill;
extern int   PVIP;
extern int   WarehousePage;
extern DWORD    BossTime;
extern char     BossName[32];
extern smTRANS_BA_SCORE * rsBattle;
...
extern std::vector<int> SkillDisabled;
...
extern int bSendGetItemInfoPerf;
...
int	Send_PersonalShopItem( DWORD dwCharCode , void *lpShopItem, int BuyType = 0);
...
extern rsTRANS_SERVER	rsMainServer;

extern DWORD	dwRecvUserServerTime;
extern DWORD	dwRecvDataServerTime;
extern DWORD	dwRecvServerTime;
extern DWORD	dwRecvExtendServerTime;

extern DWORD	dwExtendServ_RecvTime;
extern DWORD	dwUserServ_RecvTime;
extern DWORD	dwMainServ_RecvTime;
extern DWORD	dwDataServ_RecvTime;
