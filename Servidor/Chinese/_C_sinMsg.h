...
char *Money5 = "元";
char *Exp5 = "经验值";
char *WingItemName[] = {"金属之翼","银色之翼","黄金之翼","大地之翼"};
char *WarpGateName[] = {"混乱之翼","里查登","菲尔拉","黄昏树林","竹之林","废墟村庄","内维斯克","封禁之地"};
...
char *SheltomName2[] = {"圣洁","平静","祥和","火花","奇袭","锐风","黑暗","神圣","光明"};
