...
#define XM_COREDB 170 
#define XM_SERVER 171 
#define XM_LINKER	172 
...
#define ZWAVE_STATUS_NOT_INITIALIZED				MAKE_E_XSTATUS(XM_SERVER, 2)	
...
#define ZWAVE_STATUS_FAIL_RUN_FILE					MAKE_E_XSTATUS(XM_SERVER, 6)	
...
#define ZWAVE_STATUS_FAIL_INIT_DATABASE				MAKE_E_XSTATUS(XM_SERVER, 301) 

#define ZWAVE_STATUS_NCB_NOT_EXISTS					MAKE_E_XSTATUS(XM_SERVER, 302) 
#define ZWAVE_STATUS_INT_NOT_EXISTS					MAKE_E_XSTATUS(XM_SERVER, 303) 
#define ZWAVE_STATUS_XCE_NOT_EXISTS					MAKE_E_XSTATUS(XM_SERVER, 304) 
#define ZWAVE_STATUS_XVC_NOT_EXISTS					MAKE_E_XSTATUS(XM_SERVER, 305) 

#define ZWAVE_STATUS_NCB_REGISTING_FAILED			MAKE_E_XSTATUS(XM_SERVER, 306) 
#define ZWAVE_STATUS_ZCEV_REGISTING_FAILED			MAKE_E_XSTATUS(XM_SERVER, 307) 
#define ZWAVE_STATUS_ZCE_REGISTING_FAILED			MAKE_E_XSTATUS(XM_SERVER, 308) 
#define ZWAVE_STATUS_XVC_REGISTING_FAILED			MAKE_E_XSTATUS(XM_SERVER, 309) 

#define ZWAVE_STATUS_NCB_CRC_ERROR					MAKE_E_XSTATUS(XM_SERVER, 310) 
#define ZWAVE_STATUS_INT_CRC_ERROR					MAKE_E_XSTATUS(XM_SERVER, 311) 
#define ZWAVE_STATUS_XCE_CRC_ERROR					MAKE_E_XSTATUS(XM_SERVER, 312) 
#define ZWAVE_STATUS_XVC_CRC_ERROR					MAKE_E_XSTATUS(XM_SERVER, 313) 

#define ZWAVE_STATUS_MODULE_VERSION_MISMATCH		MAKE_E_XSTATUS(XM_SERVER, 314) 
#define ZWAVE_STATUS_MODULE_NOT_INITIALIZED		MAKE_E_XSTATUS(XM_SERVER, 315) 
...
#define ZWAVE_STATUS_LINKER_CREATE_EVENT_FAIL		MAKE_E_XSTATUS(XM_LINKER, 10) 
#define ZWAVE_STATUS_LINKER_TOO_MANY_SERVER		MAKE_E_XSTATUS(XM_LINKER, 11) 
