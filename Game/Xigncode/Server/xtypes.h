...
#define XGetOffset32(dst, src)		((PVOID)((ULONG) (dst) - (ULONG) (src)))
#define XGetOffset64(dst, src)		((PVOID)((ULONGLONG) (dst) + (ULONGLONG) (src)))
#define XGetOffset(dst, src)		((PVOID)((ULONG_PTR) (dst) + (ULONG_PTR) (src)))
