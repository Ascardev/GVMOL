...
static void RenderOriginalDraw( LPDIRECT3DTEXTURE9 lpD3D_Texture, D3DTLVERTEX *lpTLVertexBuff );
static void RenderAlphaDraw( LPDIRECT3DTEXTURE9 lpD3D_Texture, D3DTLVERTEX *lpTLVertexBuff, DWORD dwRGBAlpha );
static void RenderBlurDraw( LPDIRECT3DTEXTURE9 lpD3D_Texture, D3DTLVERTEX *lpTLVertexBuff );
...
int CreateNewRenderTarget(void)
{
	...
	if( lpDD == NULL || d3ddev == NULL || D3DRect.x2 > 1024 || D3DRect.y2 > 1024 )
		return -1;
	
	if( d3ddevDesc->Desc.dwMaxTextureHeight < 1024 || d3ddevDesc->Desc.dwMaxTextureWidth < 1024 )
		return -2;
    ...
    ddsd.ddpfPixelFormat.dwSize = sizeof(D3DFORMAT);
	...
	hresult = d3ddev->SetRenderTarget( 
	if ( hresult != DD_OK )
	{
		ReleaseNewRenderTarget();
