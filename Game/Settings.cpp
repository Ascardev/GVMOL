...
void Settings::Init()
{
	...
	cImages[19] = CreateTextureMaterial("game\\images\\settings\\btnsave.png", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	cImages[20] = CreateTextureMaterial("game\\images\\settings\\btnsave_.png", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	cImages[21] = CreateTextureMaterial("game\\images\\settings\\btnreset.png", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	cImages[22] = CreateTextureMaterial("game\\images\\settings\\btnreset_.png", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	cImages[23] = CreateTextureMaterial("game\\images\\settings\\btnclose.png", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	cImages[24] = CreateTextureMaterial("game\\images\\settings\\btnclose_.png", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
...
void Settings::Draw()
{
	if (cOpen)
	{
		...
		dsDrawTexImage(cImages[1], WinX - 7, WinY, 561, 451, 255);
		...
		if (MouseAction(WinX + 21, WinY + 350, 93, 23))
			dsDrawTexImage(cImages[22], WinX + 21, WinY + 350, 93, 23, 255);
		else
			dsDrawTexImage(cImages[21], WinX + 21, WinY + 350, 93, 23, 255);

		if (MouseAction(WinX + 21, WinY + 376, 93, 23))
			dsDrawTexImage(cImages[20], WinX + 21, WinY + 376, 93, 23, 255);
		else
			dsDrawTexImage(cImages[19], WinX + 21, WinY + 376, 93, 23, 255);

		if (MouseAction(WinX + 21, WinY + 402, 93, 23))
			dsDrawTexImage(cImages[24], WinX + 21, WinY + 402, 93, 23, 255);
		else
			dsDrawTexImage(cImages[23], WinX + 21, WinY + 402, 93, 23, 255);
		if (Tab == 0)
		{
			...
			dsTextLineOut(WinX + 150, WinY + 318, "Effects:", 7);
			dsTextLineOut(WinX + 363, WinY + 327, "Dynamic Lights:", 16);
			dsTextLineOut(WinX + 363, WinY + 367, "Display Damage:", 16);
			dsTextLineOut(WinX + 150, WinY + 361, "Dynamic Shadows:", 17);
			dsTextLineOut(WinX + 150, WinY + 396, "DeadScreen:", 12);

			if (bEffects)
				dsDrawTexImage(cImages[16], WinX + 150, WinY + 338, 15, 15, 255);
			else
				dsDrawTexImage(cImages[15], WinX + 150, WinY + 338, 15, 15, 255);

			dsTextLineOut(WinX + 170, WinY + 338, "ON", 3);

			if (!bEffects)
				dsDrawTexImage(cImages[16], WinX + 230, WinY + 338, 15, 15, 255);
			else
				dsDrawTexImage(cImages[15], WinX + 230, WinY + 338, 15, 15, 255);

			dsTextLineOut(WinX + 250, WinY + 338, "OFF", 3);
			...
			if (bDamage)
				dsDrawTexImage(cImages[16], WinX + 363, WinY + 387, 15, 15, 255);
			else
				dsDrawTexImage(cImages[15], WinX + 363, WinY + 387, 15, 15, 255);

			dsTextLineOut(WinX + 383, WinY + 387, "ON", 3);

			if (!bDamage)
				dsDrawTexImage(cImages[16], WinX + 443, WinY + 387, 15, 15, 255);
			else
				dsDrawTexImage(cImages[15], WinX + 443, WinY + 387, 15, 15, 255);

			dsTextLineOut(WinX + 463, WinY + 387, "OFF", 3);

			if (bShadows)
				dsDrawTexImage(cImages[16], WinX + 150, WinY + 378, 15, 15, 255);
			else
				dsDrawTexImage(cImages[15], WinX + 150, WinY + 378, 15, 15, 255);

			dsTextLineOut(WinX + 170, WinY + 378, "ON", 3);

			if (!bShadows)
				dsDrawTexImage(cImages[16], WinX + 230, WinY + 378, 15, 15, 255);
			else
				dsDrawTexImage(cImages[15], WinX + 230, WinY + 378, 15, 15, 255);

			dsTextLineOut(WinX + 250, WinY + 378, "OFF", 3);

			if (bDeadScreen)
				dsDrawTexImage(cImages[16], WinX + 150, WinY + 414, 15, 15, 255);
			else
				dsDrawTexImage(cImages[15], WinX + 150, WinY + 414, 15, 15, 255);

			dsTextLineOut(WinX + 170, WinY + 415, "ON", 3);

			if (!bDeadScreen)
				dsDrawTexImage(cImages[16], WinX + 230, WinY + 414, 15, 15, 255);
			else
				dsDrawTexImage(cImages[15], WinX + 230, WinY + 414, 15, 15, 255);

			dsTextLineOut(WinX + 250, WinY + 415, "OFF", 3);
		...
		else if (Tab == 2)
		{
			...
			if (bNaked)
				dsDrawTexImage(cImages[16], WinX + 453, WinY + 242, 15, 15, 255);
			else
				dsDrawTexImage(cImages[15], WinX + 453, WinY + 242, 15, 15, 255);
			...
			dsTextLineOut(WinX + 473, WinY + 222, "MA", 2);
			dsTextLineOut(WinX + 473, WinY + 242, "Naked", 6);
...
void Settings::Button()
{
	if (cOpen)
	{
		...
		if (Tab == 0)
		{
			...
			if (MouseAction(WinX + 150, WinY + 338, 15, 15))
				bEffects = true;
			if (MouseAction(WinX + 230, WinY + 338, 15, 15))
				bEffects = false;
			...
			if (MouseAction(WinX + 150, WinY + 378, 15, 15))
				bShadows = true;
			if (MouseAction(WinX + 230, WinY + 378, 15, 15))
				bShadows = false;

			if (MouseAction(WinX + 150, WinY + 414, 15, 15))
				bDeadScreen = true;
			if (MouseAction(WinX + 230, WinY + 414, 15, 15))
				bDeadScreen = false;

			if (MouseAction(WinX + 363, WinY + 387, 15, 15))
				bDamage = true;
			if (MouseAction(WinX + 443, WinY + 387, 15, 15))
				bDamage = false;
...
void Settings::Load()
{
	...
	bResolution = ini.ReadInt("Screen", "Resolution");
	...
	if (ini.ReadBool("Screen", "DeadScreen"))
	{
		bDeadScreen = true;
		cDeadScreen = true;
	}
	...
	if (ini.ReadBool("Game", "DisplayDamage"))
	{
		bDamage = true;
		cDamage = true;
	}
	...
	if (ini.ReadBool("LootSpecFilter", "MA"))
	{
		bMA = true;
		cMA = true;
	}
	...
	//lstrcpy(smConfig.szDataServerIP, ini.ReadString("Game", "IP"));
}
...
void Settings::Save()
{
	...
	ini.WriteBool("Screen", "DeadScreen", cDeadScreen);
	ini.WriteBool("Game", "DisplayDamage", cDamage);
	...
	if (bRatio == 0)
		ini.WriteString("Screen", "Ratio", "4:3");
	if (bRatio == 1)
		ini.WriteString("Screen", "Ratio", "5:4");
	if (bRatio == 2)
		ini.WriteString("Screen", "Ratio", "16:9");
	if (bRatio == 3)
		ini.WriteString("Screen", "Ratio", "16:10");

	ini.WriteInt("Screen", "Width", smConfig.ScreenSize.x);
	ini.WriteInt("Screen", "Height", smConfig.ScreenSize.y);
	ini.WriteInt("Screen", "Resolution", cResolution);
...
void Settings::Set(int Windowed, int iWidth, int iHeight)
{
	...
	if (d3dpp.BackBufferWidth != smConfig.ScreenSize.x && d3dpp.BackBufferHeight != smConfig.ScreenSize.y)
	{
		if (Windowed)
		{
