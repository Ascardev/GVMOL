...
int ISAOCHECK::isClanMember(char* ClanZang_id, char* gserver, char* ClanZang_ChaName, char* ret_Buf)
{
	...
	/*		"http://pristonclan.hangame.com/ServerMain/isClanMember.asp?userid=광범솔&gserver=러씨디&chname=광우전사&ticket=411");*/
...
int ISAOCHECK::AppointSubChip(char* gserver, char* clanwon)
{
	...
	sprintf(szWriteBuffer,
		"http://%s/ServerMain/ClanSubChipUpdate.asp?chname=%s&gserver=%s&ticket=%d", hostName, clanwon, gserver, 9999);
...
int ISAOCHECK::ReleaseSubChip(char* gserver, char* clanwon)
{
	...
	sprintf(szWriteBuffer,
		"http://%s/ServerMain/ClanSubChipRelease.asp?chname=%s&gserver=%s&ticket=%d", hostName, clanwon, gserver, 9999);
