...
int InitField()
{
	...
	sField[cnt].BackImageCode[1] = FIELD_BACKIMAGE_GLOWRUIN2;
	sField[cnt].BackImageCode[2] = FIELD_BACKIMAGE_NIGHTRUIN2;
	sField[cnt].BackMusicCode = BGM_CODE_NDES;
	sField[cnt].ServerCode = PLAY_SERVER_CODE_MAIN;
	...
	sField[cnt].BackMusicCode = BGM_CODE_NFORE;
	sField[cnt].ServerCode = PLAY_SERVER_CODE_EXTEND;
	...
	sField[cnt].BackImageCode[2] = 0;
	sField[cnt].ServerCode = PLAY_SERVER_CODE_EXTEND;
	sField[cnt].BackMusicCode = BGM_CODE_HELLSGATE;
...
#define	OUT_Y	830
	...
	sField[cnt].AddWarpGate(-3664, -44886, 145, 64, 32);
	sField[cnt].AddWarpOutGate(&sField[23], -2851, -43792, 642);
	sField[cnt].AddWarpOutGate(&sField[23], -4422, -43801, 642);
	...
	sField[cnt].SetName("Condado\\Condado.ASE", "Condado-Pecador");
	sField[cnt].State = FIELD_STATE_DUNGEON;
	sField[cnt].BackImageCode[0] = FIELD_BACKIMAGE_RUIN2;
	sField[cnt].BackImageCode[1] = FIELD_BACKIMAGE_GLOWRUIN2;
	sField[cnt].BackImageCode[2] = FIELD_BACKIMAGE_NIGHTRUIN2;
	sField[cnt].ServerCode = PLAY_SERVER_CODE_EXTEND;
	sField[cnt].BackMusicCode = BGM_CODE_BATTLEARENA;
	sField[cnt].SetCenterPos(-92529, -10969);
	sField[cnt].AddStartPoint(-92529, -10969);
	...
	sField[cnt].BackImageCode[1] = 0;
	sField[cnt].BackImageCode[2] = 0;
	sField[cnt].BackMusicCode = BGM_CODE_SLAB;
	sField[cnt].ServerCode = PLAY_SERVER_CODE_EXTEND;
	...
	sField[cnt].LimitLevel = 123;
	sField[cnt].WarpGate[sField[cnt].WarpGateActiveNum].LimitLevel = 123;
	cnt++;

	sField[cnt].SetName("SeaA\\SeaA.ASE", "SeaA");
	sField[cnt].State = FIELD_STATE_DUNGEON;
	sField[cnt].BackImageCode[0] = FIELD_BACKIMAGE_RAIN;
	sField[cnt].BackImageCode[1] = FIELD_BACKIMAGE_RAIN;
	sField[cnt].BackImageCode[2] = FIELD_BACKIMAGE_RAIN;
	sField[cnt].BackMusicCode = BGM_CODE_DUNGEON;
	sField[cnt].ServerCode = PLAY_SERVER_CODE_EXTEND;
	...
	sField[cnt].AddWarpGate(-21970, -5959, 157, 32, 64);
	sField[cnt].AddWarpOutGate(&sField[37], -14250, -1548, 196);
	sField[cnt].WarpGate[sField[cnt].WarpGateActiveNum].LimitLevel = 125;
	sField[cnt].AddWarpGate(-23511, 7571, 859, 32, 64);
	sField[cnt].AddWarpOutGate(&sField[50], -29930, 17161, 828);
	sField[cnt].WarpGate[sField[cnt].WarpGateActiveNum].LimitLevel = 125;
	sField[cnt].AddWarpGate(-22392, 7587, 859, 32, 64);
	sField[cnt].AddWarpOutGate(&sField[50], -29930, 17161, 828);
	sField[cnt].WarpGate[sField[cnt].WarpGateActiveNum].LimitLevel = 125;
	cnt++;
	...
	sField[cnt].BackImageCode[2] = 0;
	sField[cnt].ServerCode = PLAY_SERVER_CODE_EXTEND;
	sField[cnt].BackMusicCode = BGM_CODE_CAMERSIN;
	sField[cnt].SetCenterPos(198274, 242108);
	sField[cnt].AddStartPoint(198279, 240452);
	sField[cnt].LimitLevel = 110;
	sField[cnt].AddWarpGate(198289, 240238, 1543, 32, 32);
	cnt++;
	...
	sField[cnt].BackImageCode[2] = FIELD_BACKIMAGE_NIGHTTEMPLE;
	sField[cnt].ServerCode = PLAY_SERVER_CODE_MAIN;
	sField[cnt].BackMusicCode = 0;
	sField[cnt].SetCenterPos(-23875, 22244);
	...
	sField[cnt].BackMusicCode = BGM_CODE_DUNGEON;
	sField[cnt].ServerCode = PLAY_SERVER_CODE_MAIN;
	sField[cnt].SetCenterPos(0x701C, 0xFFFEDEF0);

	sField[cnt].LimitLevel = 155;
	...
	sField[cnt].AddWarpGate(6400, -42120, 230, 64, 32);
	sField[cnt].AddWarpOutGate(&sField[41], 5254, -41361, 139);
	sField[cnt].WarpGate[sField[cnt].WarpGateActiveNum].LimitLevel = 112;
