...
typedef int(WINAPI *H_SetBkMode)(HDC hdc, int iBkMode);
H_SetBkMode _SetBkMode;

typedef COLORREF(WINAPI *H_SetFontTextColor)(HDC hdc, COLORREF crColor);
H_SetFontTextColor _SetFontTextColor;

typedef BOOL(WINAPI *H_TextOut)(HDC hdc, int nXStart, int nYStart, LPCTSTR lpString, int cchString);
H_TextOut _TextOut;
