...
public:
	...
	int tribeNum;
	RECT menuPos[2];
	int						MoryonJobLogoImage[CHARACTER_JOB_MAX];

	int						MorFaceImage[CHARACTER_JOB_MAX][4][2];

	int USE_MOR;
	void Init_UseMor(int flag);
...
private:
	...
	LPDIRECT3DTEXTURE9      GameMapImageBorder;
	LPDIRECT3DTEXTURE9      GameMapImageBlur;
