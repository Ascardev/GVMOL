...
extern int DrawPatentMessage(int x, int y, char* spatent, char* sname, DWORD color1, DWORD color2, LPDIRECT3DTEXTURE9 clanMark, BOOL selected, int bellaMarkIndex);
extern int DrawPatentWithClanMessage(int x, int y, char* sclan, char* spatent, char* sname, DWORD color1, DWORD color2, LPDIRECT3DTEXTURE9 clanMark, BOOL selected, int bellaMarkIndex);
extern int DrawTwoLineMessage(int x, int y, char* messageOne, char* messageTwo, DWORD color1, DWORD color2, LPDIRECT3DTEXTURE9 clanMark = NULL, BOOL selected = FALSE, int bellaMarkIndex = -1, int Type = 0);
extern int DrawCharacterMessage(int x, int y, char* message, int lineSize = 30, LPDIRECT3DTEXTURE9 clanMark = NULL, char* clanName = NULL, DWORD color1 = RGB(0, 0, 0), BOOL selected = FALSE, int bellaMarkIndex = -1, int Type = 0);
...
extern HoParty_KTJ	InterfaceParty_KTJ;
