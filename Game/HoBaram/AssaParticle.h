...
#define PVP_KING			            1413

#define FIRE_MONSTER_IGNICULIS 		    1416
#define FIRE_MONSTER_FLAME_MAIDEN       1417
#define FIRE_MONSTER_INSEC       1418
#define BOSS_MONSTER_DRAXOS       1419
...
class AssaSkill5PikemanFinalSpear : public cASSAEFFECT
{
public:
	AssaSkill5PikemanFinalSpear();
	~AssaSkill5PikemanFinalSpear();
	void Start(smCHAR* character, int liveCount, char* szParticleFileName1, char* szParticleFileName2);
	void Main();
private:
	int			ParticleID, ParticleIDExt;
	BOOL		MyCharacterFlag;
	BOOL		EndFlag;
	smOBJ3D* SearchObj;
};

class AssaSkill5PikemanAmplified : public cASSAEFFECT
{
public:
	AssaSkill5PikemanAmplified();
	~AssaSkill5PikemanAmplified();
...
class AssaSkillTalariaMember : public cASSAEFFECT
{
public:
	AssaSkillTalariaMember();
	~AssaSkillTalariaMember();
	void Start(smCHAR* character, int liveCount);
	void Main();
private:
...
class AssaSkill5AtalantaGalaxyCoup : public cASSAEFFECT
{
public:
	AssaSkill5AtalantaGalaxyCoup();
	~AssaSkill5AtalantaGalaxyCoup();
...
class AssaSkill5PiercingIce : public cASSAEFFECT
{
public:
	AssaSkill5PiercingIce();
	~AssaSkill5PiercingIce();
...
class AssaSkill5PristessBlessingKrishna : public cASSAEFFECT
{
public:
	AssaSkill5PristessBlessingKrishna();
	~AssaSkill5PristessBlessingKrishna();
	void Start(smCHAR* character, int liveCount);
	void Main();
private:
...
class AssaHyperSonicEffect : public cASSAEFFECT
{
public:
	AssaHyperSonicEffect();
	~AssaHyperSonicEffect();

	void Start(smCHAR* character, int LiveTime);
	void Main();
...
class AssaSkill5MecanicianPowerEnhance : public cASSAEFFECT
{
public:
	AssaSkill5MecanicianPowerEnhance();
	~AssaSkill5MecanicianPowerEnhance();
	void Start(smCHAR* character, int liveCount);
	void Main();
private:
...
class AssaSkill5KnightCrescentMoon : public cASSAEFFECT
{
public:
	AssaSkill5KnightCrescentMoon();
	~AssaSkill5KnightCrescentMoon();
	void Start(smCHAR* character, int liveCount);
	void Main();
private:
...
class AssaSkill5AcherEvadeShot : public cASSAEFFECT
{
public:
	AssaSkill5AcherEvadeShot();
	~AssaSkill5AcherEvadeShot();
	void Start(smCHAR* character, int liveCount);
	void Main();
private:
...
class AssaSkill5ThunderRoop : public cASSAEFFECT
{
public:
	AssaSkill5ThunderRoop();
	~AssaSkill5ThunderRoop();
...
class AssaCircleTrap : public cASSAEFFECT
{
public:
	AssaCircleTrap();
	~AssaCircleTrap();
...
class AssaSkill5KnightHolyVenedicShot : public cASSAEFFECT
{
public:
	AssaSkill5KnightHolyVenedicShot();
	~AssaSkill5KnightHolyVenedicShot();
...
class AssaSkill5KnightHolyVenedic : public cASSAEFFECT
{
public:
	AssaSkill5KnightHolyVenedic();
	~AssaSkill5KnightHolyVenedic();
	void Start(smCHAR* character, int liveCount);
	void Main();
private:
...
class AssaSkill5KnightHolyVenedicPartHand : public cASSAEFFECT
{
public:
	AssaSkill5KnightHolyVenedicPartHand();
	~AssaSkill5KnightHolyVenedicPartHand();
	void Start(smCHAR* character, int liveCount);
	void Main();
private:
...
public:
	...
	void Start2(smCHAR* character, int liveTime, char* resName);
	void SetDelay(int startDelay)
	{
		StartDelay = startDelay;
	}
...
public:
	...
	void Start(POINT3D* pCur, POINT3D* pDest, int delay, DWORD dwSkillCode);
	void Main();
