...
public:
	...
	HoMinMax<D3DXVECTOR3> GetPartAngle(void) const { return(PartAngle); }
	void SetPartAngle(const HoMinMax<D3DXVECTOR3>& data) { PartAngle = data; }
protected:
...
public:
	...
	HoMinMax<D3DXVECTOR3> GetLocalAngle(void) const { return(LocalAngle); }
	void SetLocalAngle(const HoMinMax<D3DXVECTOR3>& data) { LocalAngle = data; }
protected:
...
public:
	...
	HoMinMax<D3DXVECTOR3> GetVelocity(void) const { return(Velocity); }
	void SetVelocity(const HoMinMax<D3DXVECTOR3>& data) { Velocity = data; }
...
public:
	...
	HoMinMax<D3DXVECTOR3> GetSpawnDir(void) const { return(SpawnDir); }
	void SetSpawnDir(const HoMinMax<D3DXVECTOR3>& data) { SpawnDir = data; }

	HoMinMax<D3DXVECTOR3> GetEmitRadius(void) const { return(EmitRadius); }
	void SetEmitRadius(const HoMinMax<D3DXVECTOR3>& data) { EmitRadius = data; }

	HoMinMax<D3DXVECTOR3> GetGravity(void) const { return(Gravity); }
	void SetGravity(const HoMinMax<D3DXVECTOR3>& data) { Gravity = data; }
...
public:
	...
	HoMinMax<D3DXVECTOR3> GetPosRange(void) const { return(PosRange); }
	void SetPosRange(const HoMinMax<D3DXVECTOR3>& data) { PosRange = data; }

	D3DXVECTOR3 GetPos(void) const { return(Pos); }
