...
static void SetFzmCharPos(void)
{
	...
	if (StageField[lpCurPlayer->OnStageField]->FieldCode == 40 || StageField[lpCurPlayer->OnStageField]->FieldCode == 41 || StageField[lpCurPlayer->OnStageField]->FieldCode == 43 || StageField[lpCurPlayer->OnStageField]->FieldCode == 44
		|| StageField[lpCurPlayer->OnStageField]->FieldCode == 45 || StageField[lpCurPlayer->OnStageField]->FieldCode == 46 || StageField[lpCurPlayer->OnStageField]->FieldCode == 47 || StageField[lpCurPlayer->OnStageField]->FieldCode == 48 || StageField[lpCurPlayer->OnStageField]->FieldCode == 49 || StageField[lpCurPlayer->OnStageField]->FieldCode == 50 || StageField[lpCurPlayer->OnStageField]->FieldCode == 51)
	{
		return;
	}
...
int SetFullZoomMap(int IsSet)
{
	if (IsSet)
	{
		...
		if (lpCurPlayer->OnStageField >= 0)
		{
			...
			if (iFieldCode == 40 || iFieldCode == 41 || iFieldCode == 43 || iFieldCode == 44 || iFieldCode == 45 || iFieldCode == 46 || iFieldCode == 47 || iFieldCode == 48 || iFieldCode == 49 || iFieldCode == 50 || iFieldCode == 51)
			{
