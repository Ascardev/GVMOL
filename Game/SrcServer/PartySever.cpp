...
int rsPLAYINFO::GetPartyExp(smCHAR* lpChar, rsPLAYINFO* lpPlayInfo)
{
	...
	//Mob zerado, acrescenta 1xp para não bugar a party
	...
	Exp = srGetTotalExp(lpChar->smMonsterInfo.GetExp, lpPlayInfo->smCharInfo.Level);
	Exp += (Exp * ((PartyUserCount - 1) * 5)) / 100;

	PartyExp[0] = Exp;			//º»ÀÎ È¹µæ
	PartyExp[1] = Exp;			//ÆÄÆ¼¿ø È¹µæ
