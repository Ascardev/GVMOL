...
#define SIN_REMODEL       13
#define SIN_SYSTEM		14
...
void DrawSprite(int winX, int winY, LPDIRECT3DTEXTURE9 pdds, int x, int y, int width, int height, int Bltflag = 1, int destWidth = -1, int destHeight = -1);
