...
public:
	...
	LPDIRECT3DTEXTURE9	lpShowCostumeGearCover;
	LPDIRECT3DTEXTURE9	lpShowCostumeGearButton;
	LPDIRECT3DTEXTURE9	lpShowCostumeGearButtonInfo;

	LPDIRECT3DTEXTURE9   lpPuzzleInven;
	LPDIRECT3DTEXTURE9   lpPuzzlewidth;
	LPDIRECT3DTEXTURE9   lpPuzzleHeight;

	BOOL ShowCostumeGear;
	...
	int m_Resurrection_Exp;
	int m_Resurrection_Money;
	BOOL m_bIsCostumeArmor;
	BOOL m_bEnableEffectLoad;
	BOOL m_bEnableEffectRelease;
	int m_iEssenceOfGhostEventItemIndex;
	int m_nRuneStr;
	int m_nRuneHealth;
	int m_nRuneTalent;
	int m_nRuneSpirit;
...
public:
	...
	int cINVENTORY::GetMaxGold(bool Warehouse);
...
extern BOOL bChangeSetCostumeFlag;
