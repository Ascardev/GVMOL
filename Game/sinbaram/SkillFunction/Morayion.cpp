...
int F_H_Benedic()
{
	pUseSkill->UseTime = H_Benedic_Time[pUseSkill->Point - 1];
	sinContinueSkillSet(pUseSkill);
	sinUseManaStamina(pUseSkill);
	cInvenTory.SetItemToChar();
	return TRUE;
...
int F_Summon_Ramiel()
{
	pUseSkill->UseTime = Summon_Ramiel_Time[pUseSkill->Point - 1];
	sinUseManaStamina(pUseSkill);
	sinContinueSkillSet(pUseSkill);
	return TRUE;
}
...
int F_Krishna()
{
	pUseSkill->UseTime = Krishna_Time[pUseSkill->Point - 1];
	sinUseManaStamina(pUseSkill);
	sinContinueSkillSet(pUseSkill);
	return TRUE;
}
...
int F_Anima()
{
	pUseSkill->UseTime = Anima_Time[pUseSkill->Point - 1];
	sinUseManaStamina(pUseSkill);
	sinContinueSkillSet(pUseSkill);
	return TRUE;
}
...
int F_ChasingHunt()
{
	pUseSkill->UseTime = ChasingHunt_Time[pUseSkill->Point - 1];
	sinContinueSkillSet(pUseSkill);
	sinUseManaStamina(pUseSkill);
	sinSwitchSkill(pUseSkill);
