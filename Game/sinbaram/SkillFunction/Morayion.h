...
extern int Vengeance_AttackRate[10];
...
extern int Chain_Lightning_Damage[10][2];
...
extern int AdventMigal_AttackPower[10];
...
extern int H_Benedic_UndeadDamage[10];
extern int H_Benedic_Time[10];
extern int H_Benedic_UseMana[10];

extern int Talaria_Speed[10];
extern int Talaria_Time[10];
extern int Talaria_UseMana[10];

extern int G_Coup_Damage[10];
extern int G_Coup_Area[10];
extern int G_Coup_UseMana[10];

extern int Arcuda_Damage[10][2];
extern int Arcuda_Hit[10];
extern int Arcuda_Defense[10];
extern int Arcuda_Life[10];
extern int Arcuda_UseMana[10];

extern int S_Fear_DamagePercent[10];
extern int S_Fear_Range[10];
extern int S_Fear_UseMana[10];
extern int S_Fear_AddCritical[10];

extern int Silraphim_Damage[10];
extern int Silraphim_Area[10];
extern int Silraphim_UseMana[10];

extern int Tenus_HP[10];
extern int Tenus_Damage[10];
extern int Tenus_Time[10];
extern int Tenus_UseMana[10];

extern int Ignis_Damage[10];
extern int Ignis_UseMana[10];

extern int Anima_Damage[10];
extern int Anima_Mana[10];
extern int Anima_Time[10];
extern int Anima_UseMana[10];

extern int S_Impact_Damage[10];
extern int S_Impact_Area[10];
extern int S_Impact_UseMana[10];

extern int P_Ice_Damage[10];
extern int P_Ice_UseMana[10];

extern int Summon_Ramiel_Damage[10][2];
extern int Summon_Ramiel_Attack_Delay[10];
extern int Summon_Ramiel_UndeadAbsorbPercent[10];
extern int Summon_Ramiel_BlockPercent[10];
extern int Summon_Ramiel_Time[10];
extern int Summon_Ramiel_UseMana[10];

extern int Krishna_Defense[10];
extern int Krishna_Abs[10];
extern int Krishna_Time[10];
extern int Krishna_UseMana[10];

extern int Creed_IncreaseMana[10];
extern int Creed_IncreaseStamina[10];
extern int Creed_Time[10];
extern int Creed_UseMana[10];

extern int P_Deity_Damage[10];
extern int P_Deity_Range[10];
extern int P_Deity_UseMana[10];

extern int G_Nail_Damage[10];
extern int G_Nail_UseMana[10];

extern int H_Regene_IncreaseHP[10];