...
namespace Launcher
{
    public partial class Form1 : Form
    {
        ...
        {
            string Server = "http://191.96.78.251/Launcher/";
        ...
        private void bgwProcesso_ProgressChanged(object sender, ProgressChangedEventArgs e)
        {
            ...
            lblVerUpdate.Text = " Baixando :" + vs + " " + e.ProgressPercentage + "%";
        }
        ...
        private void tmLoading_Tick(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    Process.Start(@Root + "Game.exe", "Jhonny");
                    Application.Exit();
                }
                catch (Exception erro)
                {
